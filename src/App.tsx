...
const LEADERS: Leader[] = [
  {
    ...
    images: {
      // Updated to use the consistent working image for all environments as requested
      warroom: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Hitler_portrait_crop.jpg/320px-Hitler_portrait_crop.jpg',
      rally: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Hitler_portrait_crop.jpg/320px-Hitler_portrait_crop.jpg',
      conference: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Hitler_portrait_crop.jpg/320px-Hitler_portrait_crop.jpg',
      radio: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Hitler_portrait_crop.jpg/320px-Hitler_portrait_crop.jpg'
    }
  },
  {
    id: 'dictator_2',
...
const App: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      if (activeSessionId) {
        db.saveSession({ id: activeSessionId, userId: currentUser.id, title: currentSession?.title || 'NEW_OPERATION', timestamp: new Date().toISOString(), leaderId: selectedLeaderId, style: selectedStyle, messages: finalMessages })
